        ...
        <div class="row flex-nowrap">
              ...
              <div class="card">
                <div class="card-header">
                  <a class="btn btn-primary" href="buatdatawarga.php" type="button">Tambah</a>
                  ...
                  <tr>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="detail.php?id_warga=<?php echo $data['id_warga']; ?>">Detail</a></li>
                        <li><a class="dropdown-item" href="#">Cetak</a></li>
                        <li><a class="dropdown-item" href="ubahdatawarga.php?id_warga=<?php echo $data['id_warga']; ?>">Ubah</a></li>
